  ...
  return (
    <div>
      <div onMouseOver = {props.onMouseOverForMenuLinks} onMouseOut = {props.onMouseOutForMenuLinks} className = {props.isMenuClickOpen ? MenuStyles.wrapBlock + " " + MenuStyles.wrapBlockOpen : MenuStyles.wrapBlock}>
        <p onClick = {props.onClickComponentsTransition}><NavLink to = "/aboutme">About me</NavLink></p>
        <p onClick = {props.onClickComponentsTransition}><NavLink to = "/portfolio">Portfolio</NavLink></p>
        <p onClick = {props.onClickComponentsTransition}><NavLink to = "/contacts">Contacts</NavLink></p>
      </div>
    </div>
  )
}
