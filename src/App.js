  ...
  return (
    ...
    <CSSTransition in ={inPropApp}  timeout={100} classNames={{
      ...
      <Switch location = {location}>
        <Route exact path = "/" render = {() => <Welcome onClickComponentsTransition = {onClickComponentsTransition} />} />
        <Route path = "/:paths" render = {() => <ContentWithRouter setinPropApp = {setinPropApp} onClickComponentsTransition = {onClickComponentsTransition} />} />
      </Switch>
    </CSSTransition>
    </div>
